...
export const threadCreate = async (authorId: string, description: string) => {
  if ((await validationThreadCreate(authorId, description)) === -1)
...
export const threadLikes = async (threadId: string, userId: string) => {
  if ((await validationThreadLike(threadId, userId)) === -1)
    return "Can't be empty";
  if ((await validationThreadLike(threadId, userId)) === -2)
    return "Can't find thread";
  if ((await validationThreadLike(threadId, userId)) === -3)
...
export const threadSave = async (threadId: string, userId: string) => {
  if ((await validationThreadSave(threadId, userId)) === -1)
    return "Can't be empty";
  if ((await validationThreadSave(threadId, userId)) === -2)
    return "Can't find thread";
  if ((await validationThreadSave(threadId, userId)) === -3)
    return "Can't find user";
...
export const threadUpdate = async (
  ...
  if ((await validationThreadUpdate(threadId, authorId, description)) === -2)
    return "threadId can't find";
  if ((await validationThreadUpdate(threadId, authorId, description)) === -3)
...
export const threadDelete = async (threadId: string, authorId: string) => {
  if ((await validationThreadDelete(threadId, authorId)) === -1)
    return "threadId and authorId can't be empty";
  if ((await validationThreadDelete(threadId, authorId)) === -2)
    return "threadId can't find";
  if ((await validationThreadDelete(threadId, authorId)) === -3)
    return "userId can't find";
...
export const threadComment = async (
  ...
  if ((await validationThreadComment(threadId, userId, description)) === -1)
    return "threadId, authorId, description can't be empty";
  if ((await validationThreadComment(threadId, userId, description)) === -2)
    return "threadId can't find";
