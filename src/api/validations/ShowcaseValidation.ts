...
export const validationShowcaseDetail = async (id: string) => {
  const showcase = await prisma.showCase.findFirst({ where: { id } });
...
export const validationShowcaseLike = async (
  showCaseId: string,
  userId: string
) => {
...
export const validationShowcaseSave = async (
  showCaseId: string,
  userId: string
) => {
  if (!showCaseId || !userId) return -1;
...
export const validationShowcaseDelete = async (
  showcaseId: string,
  authorId: string
) => {
...
export const validationShowcaseComment = async (
  showcaseId: string,
  userId: string,
  description: string
) => {
