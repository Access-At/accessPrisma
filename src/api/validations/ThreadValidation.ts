...
export const validationThreadCreate = async (
  authorId: string,
  description: string
) => {
...
export const validationThreadLike = async (
  threadId: string,
  userId: string
) => {
...
export const validationThreadSave = async (
  threadId: string,
  userId: string
) => {
  if (!threadId || !userId) return -1;
...
export const validationThreadUpdate = async (
  threadId: string,
  authorId: string,
  description: string
) => {
...
export const validationThreadDelete = async (
  threadId: string,
  authorId: string
) => {
...
export const validationThreadComment = async (
  threadId: string,
  userId: string,
  description: string
) => {
